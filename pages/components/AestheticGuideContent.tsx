...
export default function PostPage(props: Props) {
  return (
    <>
              ...
              <div>
                <div style={style.HeadingAndText}>
                  ...
                  <p>
                    ...
                    however only 3 months of summer at the maximum. As a result
                    many areas of the city are not used during winter becuase
                    there are no public facilities to use. We wanted to research
                    what we could do differently to have activities all year
                    round.
                  </p>
                </div>
              </div>
            ...
            <div style={style.onlyTextSection}>
              <div style={style.HeadingAndText}>
                ...
                <p>
                  ...
                  ice skating rink. There are also options for taking a stroll,
                  sitting at the benches and enjoying a hot beverage in the
                  café.
                </p>
              </div>
            </div>
      ...
      <div style={style.wrapper}>
        <div className="marker" style={style.marker2}>
          Process
        </div>
        <div style={style.container}>
          <div>
          ...
          <div style={style.spaceBetweenSection}>
            <div>
              <div style={style.HeadingAndText}>
                ...
                <p>
                  After the field study we split into groups that included city
                  planners, architects, landscape architects and industrial
                  designers. We dug into Oslo's history and collected a survey
                  on the locals in the area. Thats when we decided to bring the
                  old colors of Oslo back to life with a new interpretation. My
                  group also chose to look closer at how to bring the city to
                  life during winter.
                </p>
              </div>
            </div>
            ...
            <div style={style.onlyTextSection}>
              <div style={style.HeadingAndText}>
                <p>
                  ...
                  industrial designers and I also worked as editors for both the
                  content and the layout of the entire document. It was a huge
                  challange seen as though none of us had ever created a book
                  before - let alone with 30 different collaborators. <br />
                  <br />
                  We created systems for image and information collection and
                  tried to automate as much of the process as possible. During
                  the editing we learned the ins and outs of Adobe InDesign and
                  the challanges with actually sending a ready made document to
                  the publisher.
                  <br />
                  <br />
                ...
                <ExternalLink
                  ...
                  text={'Download the document here (Norwegian)'}
                />
              </div>
            </div>
          </div>
